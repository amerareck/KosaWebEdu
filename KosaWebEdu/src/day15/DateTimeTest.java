...
public class DateTimeTest {
	...
	public static void main(String[] args) throws Exception {
		...
		LocalDate currentDate = LocalDate.now(); // 현재 시점
		LocalDate targetDate = LocalDate.of(2023, 9, 1); // 커스텀 시점
		...
		LocalDate birth = LocalDate.of(1998, 9, 23);
        System.out.println("정준범은 " +birth.getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.KOREAN)+ "에 태어났어요");
	}
